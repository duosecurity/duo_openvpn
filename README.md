...
Download the [Duo OpenVPN v3.1 plugin](https://github.com/duosecurity/duo_openvpn/archive/3.1.tar.gz) by clicking this link or by downloading the ZIP for this repository. Then extract it, build, and install the plugin.

```
$ cd duo_openvpn-3.1 OR cd duo_openvpn-master
